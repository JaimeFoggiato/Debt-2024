...
df = pd.read_excel('deals-7428260-2374.xlsx', usecols=['Negócio - Título', 'Negócio - Data do Acidente', 'Negócio - Veículo 3º', 'Pessoa - Telefone', 'Negócio - Pasta'])
...
df.to_excel('Disparo Cynthia 20.12.23.xlsx', index=False)
