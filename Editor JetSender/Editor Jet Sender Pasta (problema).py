...
df = pd.read_excel('deals-7428260-2353.xlsx', usecols=['Negócio - Título', 'Negócio - Data do Acidente', 'Negócio - Veículo Segurado', 'Pessoa - Telefone', 'Numero - Sinistro', 'Negócio - Pasta'])
...
df = df.melt(id_vars=['Negócio - Título', 'Negócio - Data do Acidente', 'Negócio - Veículo Segurado', 'Numero - Sinistro', 'Pessoa - Telefone'], var_name='Telefone', value_name='Número')

# Exlcui as linhas em branco
df = df.dropna(subset=['Negócio - Título', 'Negócio - Data do Acidente', 'Negócio - Veículo Segurado', 'Numero - Sinistro', 'Pessoa - Telefone'])
...
df.to_excel('JetSender Segurado.xlsx', index=False)