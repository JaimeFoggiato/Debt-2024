...
df = pd.read_excel('Planilha JetGO sem alteracao.xlsx', usecols=['Negócio - Título', 'Negócio - Data do Acidente', 'Negócio - Veículo 3º', 'Pessoa - Telefone', 'Pessoa - CPF/CNPJ', 'Negócio - Pasta', 'Negócio - Placa do veículo terceiro', 'Negócio - Valor', 'Negócio - Veículo Segurado'])
...
df = df.melt(id_vars=['Título', 'Pessoa - Telefone', 'Pessoa - CPF/CNPJ', 'Negócio - Data do Acidente', 'Nome completo', 'Negócio - Pasta', 'Negócio - Placa do veículo terceiro', 'Negócio - Valor', 'Negócio - Veículo 3º', 'Negócio - Veículo Segurado'], var_name='Telefone', value_name='Número')

# Exlcui as linhas em branco
df = df.dropna(subset=['Título', 'Pessoa - Telefone', 'Pessoa - CPF/CNPJ', 'Negócio - Data do Acidente', 'Nome completo', 'Negócio - Pasta', 'Negócio - Placa do veículo terceiro', 'Negócio - Valor', 'Negócio - Veículo 3º', 'Negócio - Veículo Segurado'])
...
df.to_excel('Resultado Planilha JetGo.xlsx', index=False)